...
// Xử lý sửa thông tin (trừ mật khẩu)
...
// Xử lý đổi mật khẩu riêng (admin có thể đặt lại mật khẩu)
            ...
            <div class="table-responsive">
                <table class="table table-striped mb-0 align-middle">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <button class="btn btn-sm btn-warning me-1" data-bs-toggle="modal" 
                                        data-bs-target="#editModal<?php echo $user['id']; ?>">Sửa</button>

                                <!-- Nút đặt lại mật khẩu -->
                                <button class="btn btn-sm btn-info me-1" data-bs-toggle="modal"
                                        data-bs-target="#passwordModal<?php echo $user['id']; ?>">Đổi MK</button>

                                <!-- Nút xóa -->
                                <form method="POST" style="display:inline;">
                                    <input type="hidden" name="id" value="<?php echo $user['id']; ?>">
                                    <button type="submit" name="delete_user" class="btn btn-sm btn-danger"
                                            onclick="return confirm('Xóa người dùng này? Tất cả lịch sử mượn sách sẽ bị xóa!')">
                                        Xóa
                                    </button>
                                </form>
                            </td>
                        ...
                        <!-- Modal Đổi Mật Khẩu -->
                        <div class="modal fade" id="passwordModal<?php echo $user['id']; ?>">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <form method="POST">
                                        <div class="modal-header">
                                        ...
                                        <div class="modal-footer">
                                            <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Hủy</button>
                                            <button type="submit" name="reset_password" class="btn btn-info">Đặt Lại</button>
                                        </div>
                                    </form>
                                </div>
                            </div>
